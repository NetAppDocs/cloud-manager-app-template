...
* Activate link:concept-backup-to-cloud.html[Cloud Backup] on volumes (not applicable for Azure NetApp Files)
* Activate link:concept-cloud-compliance.html[Cloud Data Sense] on volumes
* Activate link:concept-replication.html[Replication] on volumes (not applicable for Azure NetApp Files)
