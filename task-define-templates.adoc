...
* If you don't already have a Connector, https://docs.netapp.com/us-en/cloud-manager-get-started/concept-connectors.html[see how to create Connectors^] for AWS, Azure, and GCP.
